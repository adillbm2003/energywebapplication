...
export const homeQuickAccess = [
  ...
  { label: 'Public Sector Fleet', to: ROUTES.projectDetail('prj-dpt-electrification'), image: PAGE_IMAGES.electricBuses },
  { label: 'Balcony Solar Pilot', to: ROUTES.projectDetail('prj-balcony-solar'), image: PAGE_IMAGES.balconySolar },
  { label: 'EV Adoption', to: ROUTES.transitionDashboard, image: PAGE_IMAGES.electricBus },
