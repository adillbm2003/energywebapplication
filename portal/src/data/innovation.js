...
export const innovationTopics = [
  ...
  { title: 'Demand Response', description: 'Technologies enabling consumers to reduce load during peak periods.', status: 'Active', image: PAGE_IMAGES.efficiency, linkTo: ROUTES.transitionDashboard, linkLabel: 'Transition dashboard' },
  ...
  { title: 'Advanced Energy Analytics', description: 'Data-driven insights for policy, planning, and operational decisions.', status: 'Active', image: PAGE_IMAGES.registry, linkTo: ROUTES.renewableDashboard, linkLabel: 'Explore dashboards' },
